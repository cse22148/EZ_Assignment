          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex justify-center lg:justify-start">
              <div className="bg-white rounded-lg shadow-xl overflow-hidden max-w-md w-full card-hover-lift group">
                <div className="relative w-full h-80 bg-gray-200">
                  <Image
                    src="/outdoor-art-festival-with-colorful-tent-and-creati.jpg"
                    alt="Art Curation"
                    fill
                ...
                <div className="p-6 text-center bg-white group-hover:bg-accent/5 transition-colors duration-300">
                  <h3 className="text-xl font-semibold text-primary">Art Curation</h3>
                </div>
              </div>
            </div>
            ...
            <div className="animate-slide-in-right">
              ...
              <p className="text-lg text-foreground/80 mb-6 leading-relaxed">
                Through every festival, every performance, and every gathering, we help stories find their stage and
                their people.
              </p>

              {/* Services List */}
              <div className="mb-8">
                <p className="font-semibold text-primary mb-4">V curates:</p>
                <ul className="space-y-3">
                  <li className="flex items-start text-foreground/80 group hover:translate-x-2 transition-transform duration-300">
                    ...
                    <span className="group-hover:text-accent transition-colors duration-300">Art Festivals</span>
                  </li>
                  <li className="flex items-start text-foreground/80 group hover:translate-x-2 transition-transform duration-300">
                    <span className="text-accent mr-3 group-hover:scale-125 transition-transform duration-300">•</span>
                    <span className="group-hover:text-accent transition-colors duration-300">Live Performances</span>
                  </li>
                  <li className="flex items-start text-foreground/80 group hover:translate-x-2 transition-transform duration-300">
                    <span className="text-accent mr-3 group-hover:scale-125 transition-transform duration-300">•</span>
                    <span className="group-hover:text-accent transition-colors duration-300">Community Events</span>
                  </li>
                  <li className="flex items-start text-foreground/80 group hover:translate-x-2 transition-transform duration-300">
                    <span className="text-accent mr-3 group-hover:scale-125 transition-transform duration-300">•</span>
