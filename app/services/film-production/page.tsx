          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex justify-center lg:justify-start">
              <div className="bg-white rounded-lg shadow-xl overflow-hidden max-w-md w-full card-hover-lift group">
                <div className="relative w-full h-80 bg-gray-200">
                  <Image
                    src="/professional-film-production-scene.jpg"
                    alt="Film Production"
                    fill
                ...
                <div className="p-6 text-center bg-white group-hover:bg-accent/5 transition-colors duration-300">
                  <h3 className="text-xl font-semibold text-primary">Film Production</h3>
                </div>
              </div>
            </div>
            ...
            <div className="animate-slide-in-right">
              ...
              <p className="text-lg text-foreground/80 mb-6 leading-relaxed">
                We see them as a way to live many lives - to feel, to explore, and to tell stories that stay. And with
                each film, we carry new memories and new reasons to keep creating.
              </p>

              {/* Services List */}
              <div className="mb-8">
                <p className="font-semibold text-primary mb-4">V crafts:</p>
                <ul className="space-y-3">
                  <li className="flex items-start text-foreground/80 group hover:translate-x-2 transition-transform duration-300">
                    ...
                    <span className="group-hover:text-accent transition-colors duration-300">Documentaries</span>
                  </li>
                  <li className="flex items-start text-foreground/80 group hover:translate-x-2 transition-transform duration-300">
                    <span className="text-accent mr-3 group-hover:scale-125 transition-transform duration-300">•</span>
                    <span className="group-hover:text-accent transition-colors duration-300">Corporate Videos</span>
                  </li>
                  <li className="flex items-start text-foreground/80 group hover:translate-x-2 transition-transform duration-300">
                    <span className="text-accent mr-3 group-hover:scale-125 transition-transform duration-300">•</span>
                    <span className="group-hover:text-accent transition-colors duration-300">2D Animation Videos</span>
                  </li>
                  <li className="flex items-start text-foreground/80 group hover:translate-x-2 transition-transform duration-300">
                    <span className="text-accent mr-3 group-hover:scale-125 transition-transform duration-300">•</span>
                    <span className="group-hover:text-accent transition-colors duration-300">3D Animation Videos</span>
                  </li>
                </ul>
              </div>
